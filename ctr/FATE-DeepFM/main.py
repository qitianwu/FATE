...
parser = argparse.ArgumentParser(description='FATE-DeepFM')
...
parser.add_argument('--lr1', type=float, default=1e-4, help='learning_rate for pretrain') # 1e-4 for criteo
parser.add_argument('--wd1', type=float, default=1e-5, help='weight_decay for pretrain') # 1e-2 for criteo
parser.add_argument('--lr2', type=float, default=1e-5, help='learning_rate for train') # 1e-4 for criteo
parser.add_argument('--wd2', type=float, default=0., help='weight_decay for train') # 0 for criteo
...
parser.add_argument('--known_num', type=int, default=13, help='known_ratio') # 13 for criteo
...
parser.add_argument('--dropout', type=float, default=0.5, help='dropout prob') # 0.5 for criteo
parser.add_argument('--dropedge_prob', type=float, default=0.5, help='known_ratio') # 0.5 for criteo
